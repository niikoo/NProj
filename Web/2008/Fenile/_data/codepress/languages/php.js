...
Language.syntax = [ // PHP
	...
	{ input : /(\$_[\w\.]*)/g, output : '<code>$1</code>' }, // global vars
	
	{ input : /\b(__FILE__|exception|__LINE__|array|as|class|const|declare|die|echo|empty|enddeclare|endfor|endforeach|endif|endswitch|endwhile|eval|exit|explode|extends|function|global|isset|list|print|static|strlen|strtolower|unset|use|__FUNCTION__|__CLASS__|__METHOD__|final|php_user_filter|interface|implements|extends|public|private|protected|abstract|clone|try|catch|throw)\b/g, output : '<u>$1</u>' }, // reserved words
	
	{ input : /\b(false|true|and|or|xor|as|break|case|class|continue|declare|default|do|else|elseif|for|foreach|if|include|include_once|new|require|require_once|return|switch|while|this)\b/g, output : '<code><strong>$1</strong></code>' }, // reserved words 2
